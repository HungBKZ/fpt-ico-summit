...
export const en: Dictionary = {
  ...
  partnerCms: {
    ...
    shortDescViLabel: "Vietnamese Short Description (Optional)",
    descViLabel: "Vietnamese Full Overview (Optional)",
    viSectionNote: "Optional. You may leave this section blank if Vietnamese content is not available. The Summit organizing team may prepare the Vietnamese version for public communication when necessary.",
  ...
  partnerActivities: {
    ...
    topicChangesRequestedBadge: "Topic Changes Requested",
    postEventSharingPermissionLabel: "Post-Event Material Sharing Permission",
    interpretationLabel: "Interpretation Preferences",
  },
  adminActivities: {
    ...
    acceptTopicBtn: "Accept Topic Proposal (Stage A)",
    requestTopicChangesBtn: "Request Topic Changes",
  ...
  adminShowcase: {
    ...
    subtitle: "Manage international institutions and organizations displayed on the homepage logo marquee.",
    addBtn: "+ Add Organization Logo",
    metricTotal: "Total Entries",
    metricVisible: "Visible on Homepage",
    metricInvited: "Invited",
    metricConfirmed: "Confirmed",
    metricNetwork: "Network Partners",
    tabAll: "All Entries",
    tabInvited: "Invited",
    tabConfirmed: "Confirmed",
    tabNetwork: "Network Partners",
    tabVisible: "Visible",
    tabHidden: "Hidden",
    colLogo: "Logo",
    colName: "Institution / Organization Name",
    colCountry: "Country",
    colStatus: "Relationship Status",
    colVisibility: "Homepage Visibility",
    colOrder: "Order",
    colLinkedOrg: "Linked Organization",
    colUpdatedAt: "Updated At",
    colActions: "Actions",
    statusInvited: "Invited",
    statusConfirmed: "Confirmed",
    statusNetwork: "Network Partner",
    visibilityVisible: "Visible",
    visibilityHidden: "Hidden",
    emptyList: "No partner showcase entries found matching your criteria.",
    modalAddTitle: "Add Organization Logo",
    modalEditTitle: "Edit Showcase Entry",
    fieldName: "Organization / Institution Name",
    ...
    uploadingLogo: "Uploading & Verifying...",
    changeLogoBtn: "Replace Logo",
    noOrgLinked: "None (Showcase-only entry)",
    saveBtn: "Save Entry",
    savingBtn: "Saving...",
    saveAndContinueBtn: "Save & Continue to Logo Upload",
    finishBtn: "Save & Finish",
    backToStep1Btn: "Back to Details",
    cancelBtn: "Cancel",
    deleteBtn: "Delete",
    deleteConfirm: "Are you sure you want to delete this showcase entry? This will permanently remove the entry and its uploaded Cloudinary logo asset.",
    consentNotice: "Public display consent and a verified logo are strictly required before an entry can be made visible on the public homepage.",
    missingLogoWarning: "Upload and verify a logo before enabling homepage visibility.",
    searchPlaceholder: "Search by institution name or country...",
