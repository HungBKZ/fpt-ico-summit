...
export function SouvenirSection({ locale, dict }: SouvenirSectionProps) {
    ...
    ? [
        {
          ...
          label: "Sản phẩm quà tặng chính thức của Summit",
        },
        {
          icon: (
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          label: "Trưng bày & trải nghiệm quà lưu niệm tại chỗ",
        },
        {
          icon: (
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          label: "Kỷ vật sự kiện & sản phẩm văn hóa độc đáo",
        },
        {
          icon: (
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          label: "Gian hàng ẩm thực & thức uống tại khuôn viên",
        },
      ]
    : [
        {
        ...
        <div className="souvenir-layout">
          ...
          <RevealOnScroll className="souvenir-text" delay={0}>
            <div style={{ display: "flex", flexDirection: "column", gap: "1.75rem" }}>
              <SectionHeading
                id="souvenir-heading"
                eyebrow={dict.souvenirs.eyebrow}
                heading={dict.souvenirs.title}
                body={dict.souvenirs.subtitle}
                level="h2"
                align="left"
                accent={true}
              />
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                <span className="souvenir-chip">{dict.hero.datesValue}</span>
                <span className="souvenir-chip">{dict.hero.venueValue}</span>
              </div>
              ...
              >
                {locale === "vi"
                  ? "Thông tin sản phẩm lưu niệm chi tiết sẽ được công bố gần ngày diễn ra sự kiện."
