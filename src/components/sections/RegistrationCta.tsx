...
export function RegistrationCta({ locale, dict }: RegistrationCtaProps) {
            ...
            <div>
              ...
              {open && (
                <div className="reg-qr-block" style={{ marginTop: "1.5rem" }}>
                  <p className="reg-qr-label">{dict.registration.scanQr}</p>
